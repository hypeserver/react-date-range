  ...
  function DateRange(props, context) {
    ...
    _defineProperty(_assertThisInitialized(_this), "calcNewSelection", function (value) {
      ...
      var _this$props = _this.props,
          ...
          allowDisabledSelection = _this$props.allowDisabledSelection;
      ...
      return {
        ...
        range: !allowDisabledSelection ? {
          startDate: startDate,
          endDate: endDate
        } : {
          startDate: startDate,
          endDate: endDate,
          inValidDatesWithinRange: inValidDatesWithinRange
        },
...
DateRange.propTypes = _objectSpread(_objectSpread({}, _Calendar["default"].propTypes), {}, {
  ...
  allowDisabledSelection: _propTypes["default"].bool
});
