...
| allowDisabledSelection(DateRange)               | Boolean    | false                                                                                                        | Allow Selection over the disabled values.                                                                                                                                                                                  |
| showDefinedRange(DateRangePicker)               | Boolean    | true                                                                                                         | Show Defined range diaglog                                                                                                                                                                                                 |
