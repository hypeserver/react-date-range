...
class Calendar extends Component {
  ...
  renderMonthAndYear(classes) {
    ...
    return (
      <div
        style={onlyClasses ? undefined : styles['MonthAndYear']}
        ...
        {showMonthArrow ? (
          <button
            ...
            <i
              style={
                onlyClasses ? undefined : { ...styles['MonthArrow'], ...styles['MonthArrowPrev'] }
              }
            />
          </button>
        ) : null}
        ...
        {showMonthArrow ? (
          <button
            ...
            <i
              style={
                onlyClasses ? undefined : { ...styles['MonthArrow'], ...styles['MonthArrowNext'] }
              }
            />
          </button>
        ) : null}
