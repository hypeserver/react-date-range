...
export default (customTheme = {}) => {
  ...
  const cellSize =
    (parseInt(calendarWidth) - parseInt(calendarPadding) * 2) / 7 - parseInt(cellMargin) * 2;
  ...
  return {
    ...
    PredefinedRangesItem: {
      ...defaultTheme.PredefinedRangesItem,
      ...customTheme.PredefinedRangesItem,
    },

    PredefinedRangesItemActive: {
      ...defaultTheme.PredefinedRangesItemActive,
      ...customTheme.PredefinedRangesItemActive,
    },
  };
};
