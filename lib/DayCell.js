...
var DayCell = (function (_Component) {
  ...
  _createClass(DayCell, [{
    ...
    value: function getStateStyles() {
      ...
      var isSpecialDay = _props3.isSpecialDay;
    ...
    value: function getClassNames(classes) {
      ...
      var isSpecialDay = _props4.isSpecialDay;
      var isDisabled = _props4.isDisabled;

      return (0, _classnames3['default'])((_classnames = {}, _defineProperty(_classnames, classes.day, true), _defineProperty(_classnames, classes.dayActive, isSelected), _defineProperty(_classnames, classes.dayPassive, isPassive), _defineProperty(_classnames, classes.dayInRange, isInRange), _defineProperty(_classnames, classes.dayStartEdge, isStartEdge), _defineProperty(_classnames, classes.dayEndEdge, isEndEdge), _defineProperty(_classnames, classes.dayToday, isToday), _defineProperty(_classnames, classes.daySunday, isSunday), _defineProperty(_classnames, classes.daySpecialDay, isSpecialDay), _defineProperty(_classnames, classes.dayDisabled, isDisabled), _classnames));
    }
  }, {
    key: 'render',
...
DayCell.propTypes = {
  ...
  isSpecialDay: _react.PropTypes.bool,
