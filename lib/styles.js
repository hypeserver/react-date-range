...
exports['default'] = function () {
  ...
  return {
    ...
    CalendarDropdown: _extends({}, defaultTheme.CalendarDropdown, customTheme.CalendarDropdown),
    ...
    DropdownButton: _extends({}, defaultTheme.DropdownButton, customTheme.DropdownButton),

    DropdownButtonImage: _extends({}, defaultTheme.DropdownButtonImage, customTheme.DropdownButtonImage),

    DropdownCalendar: _extends({}, defaultTheme.DropdownCalendar, customTheme.DropdownCalendar),

    DropdownContainer: _extends({}, defaultTheme.DropdownContainer, customTheme.DropdownContainer),

    DropdownInput: _extends({}, defaultTheme.DropdownInput, customTheme.DropdownInput),
